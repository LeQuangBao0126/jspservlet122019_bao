                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <input type="text" name="street" name="street" class="form-control" />
                                                </div>
                                                <div class="col-sm-4">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <input type="text" id="rentAreas" name="rentAreas" class="form-control" />
                                                </div>
                                                  <div class="col-sm-3">
                                                ...
                                                <div class="col-sm-12">
                                                 ...
                                                 <button class="pull-left" id="btnThemToaNha"  title="Thêm Toà Nhà" class="btn btn-sucess btn-info btn-bold">
											 		Thêm Toà Nhà
										     	</button>
